...
export let textures: GPU.Texture[]

let buttons: HTMLDivElement
let add: HTMLDivElement
...
export function Setup() {
	...
	let input = document.getElementById("input") as HTMLDivElement
	img = input.children[0] as HTMLImageElement

	buttons = document.getElementById("inputButtons") as HTMLDivElement
	add = buttons.children[0] as HTMLDivElement
